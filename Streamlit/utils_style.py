...
def dist_box(gender_counts, male_counts, male_percent, female_counts, female_percent):
    ...
    with st.expander("## Key Insights", expanded=True):
        st.markdown(
            '<div class="insight-title">Total Companies:</div>'
            f"<p>{gender_counts.sum()}</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">Male Executives:</div>'
            f"{male_counts} ({male_percent}%)</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">Female Executives:</div>'
            f"{female_counts} ({female_percent}%)</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">The Highest Pct of Female Executives Based on Company Size:</div>'
            "<p> Up to 15</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">The Lowest Pct of Female Executives Based on Company Size:</div>'
            "<p>From 1001 to 2000</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">The Highest Pct of Female Executives Based on Form of Ownership:</div>'
            "</p> State</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">The Lowest Pct of Female Executives Based on Form of Ownership:</div>'
            "<p>Non-governmental</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">The Pct of Female Executives in Capital City:</div>'
            "<p>Yerevan (33%)</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">State with the Highest Pct of Female Executives:</div>'
            "<p> Aragatsotn (47%)</p>",
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div class="insight-title">State with the Lowest Pct of Female Executives:</div>'
            "<p>Vayoc Dzor (30%)</p>",
            unsafe_allow_html=True,
        )
...
def act_box():
    ...
    with st.expander("Activities and Products", expanded=True):
        st.markdown(
            '<div class="insight-title">Top 3 Activities for Women:</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
        ...
        st.markdown(
            '<div class="insight-title">Top 3 Activities for Men:</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
        ...
        st.markdown(
            '<div class="insight-title">Top 3 Products for Women:</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
        ...
        st.markdown("</div>", unsafe_allow_html=True)
        st.markdown(
            '<div class="insight-title">Top 3 Products for Men:</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
