...
if menu_option == "Home":
    include_font_awesome()
    set_background(
        "https://i.pinimg.com/736x/10/31/1b/10311bd91a872378712d17ed79435f5a.jpg"
    )
    about_us()
    contact_us()
...
# Distribution Page
    ...
    gender_counts, male_percent, female_percent = compute_gender_distribution(final_df)
...
# Timeseries Page
    ...
    st.markdown(
        '<p style="color:gray; font-size:12px;">This timeseries is based on founding year for companies who mentioned the date</p>',
